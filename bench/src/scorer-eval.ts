...
export const SCORER_MAX_CASE_MS = 30_000;
...
const ADJUDICATION_VALIDATION_CODES = new Map<string, string>([
  ...
  ["causal diff reference corpus identity mismatch", "causalDiffCorpusMismatch"],
  ["causal diff reference has no source row", "causalDiffRowMissing"],
  ["causal diff reference is not exact visible source evidence", "causalDiffRowNotVisible"],
  ["causal diff reference requires file markers", "causalDiffFileMarkersMissing"],
